...
import Analysis.TimeLog;
import Classification.BiKMeans;
import Classification.SimpleKMeans;
import Classification.ThermalZones;
import Output.ClusteringOutput;
import Performance.KMeansPerformance;
import ReadFilter.ClusterParams;
import ReadFilter.FilterData;
import ReadFilter.Record;
public class Clustering {
	static List<Analysis.TimeLog> timelog = new ArrayList<Analysis.TimeLog>();
...
//		////generate the top level reports
	...
	Analysis.TimeLog tl = new Analysis.TimeLog(start, description);
	timelog.add(tl);
	}
}
